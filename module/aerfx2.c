...
// also uncomment this to disable rate limiting:
//#define DEBUG_PRINT_ZEROLEN_URB_NO_RATELIMIT



// uncomment this to enable verbose URB receive debugging
//#define DEBUG_PRINT_URB_RECEIVE
...
#define AERIN_ALLOC_LIMIT         (1*512)
...
#ifdef DEBUG_PRINT_URB_RECEIVE
        // URB RX debugging:
        dev_info(&dev->udev->dev, "received URB: status: %d, actual_length: %u\n", urb->status, urb->actual_length);
#endif
...
#ifdef DEBUG_PRINT_ZEROLEN_URB_NO_RATELIMIT
